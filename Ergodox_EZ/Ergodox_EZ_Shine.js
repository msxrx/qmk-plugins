...
const vKeys = Array.from({length: 32}, (_, i) => i);

const vKeyNames = Array.from({length: 32}, (_, i) => `LED ${i + 1}`);

const vKeyPositions = Array.from({length: 32}, (_, i) => [i, 0]);
